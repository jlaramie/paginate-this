...
function renderRow(headers) {
  var rowTag = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : _TableRow2.default;
...
DataTable.propTypes = {
  ...
  optionalRowTag: _propTypes2.default.oneOfType([_propTypes2.default.func, _propTypes2.default.string])
};
